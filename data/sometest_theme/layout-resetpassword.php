...
<body class="nomenu">
	...
	<form method="post" action="##actionurl##" id='loginform' name='loginform' class="resetpasswordform">
		<p>
			#ciao#
		</p>
		...
		<table ##hideall##>
			...
			<tr>
				<td></td>
				<td><input type="button" value="{Go}" id='login' onclick='document.forms[0].submit()'></td>
			</tr>
			<tr>
				<td colspan='2'>
