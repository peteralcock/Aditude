...
<body onload="document.forms[0].##usernamevar##.focus();" class="nomenu login-template">
	...
	<div id="maincontainer">
		...
		<div id="introbox">
			...
			<h1>AdAdmin</h1>
			<h2>Easy ad server solution</h2>
			<p>Written for publishers who own sites and need to show banners, AdAdmin lets you sell ads, rotate banners, monitor views and clicks and more.
			</p>
			<nav>
				
				<a href="https://www.zepsec.com/adadmin-adv-software/">WEB SITE</a>
				
				<a href="https://1.envato.market/adadmin">BUY ADADMIN</a>
